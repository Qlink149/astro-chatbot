...
async def compose(
  ...
  English bypasses the LLM entirely (zero added cost).
    ...
    instruction = (
        "You rewrite WhatsApp customer-service messages for Samara, a Vedic "
        "astrology assistant. Keep the tone warm, natural, and concise. "
        "Keep emojis. Keep prices, URLs, names, and numbers EXACTLY unchanged. "
...
async def narrate(
    ...
    *,
    ...
    instruction = (
        "You are Samara, a warm Vedic astrology assistant on WhatsApp. You'll be "
        "given the INTENT of a message to convey. Write ONE short, natural, human "
        "reply that conveys it — vary your wording, sound like a real person, never "
        f"robotic. Reply in {label}. Keep it to 1-2 short lines. Keep any prices, "
        "URLs, names, and numbers exact. Use at most one emoji. Output only the message."
    )
