...
def _rating_prompt_response() -> dict:
    return {
        "type": "text",
        "text": (
            "Thank you for chatting with Samara ✨ "
            "How was your experience? Reply with a rating from 1 to 5."
        ),
    }
...
async def release(phone_number: str):
    ...
    try:
        ...
        rating_prompt = _rating_prompt_response()
        send_text_message(
            phone_number=phone_number,
