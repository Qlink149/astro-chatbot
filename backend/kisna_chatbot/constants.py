...
DEFAULT_CLIENT_ID = os.getenv("DEFAULT_CLIENT_ID", "samara").strip().lower() or "samara"
...
GUPSHUP_SOURCE = get_gupshup_source() or os.getenv("GUPSHUP_SOURCE", "919549549339")
...
# Phase 2 payments redirect placeholder
RAZORPAY_REDIRECT = "https://wa.me/919549549339"
